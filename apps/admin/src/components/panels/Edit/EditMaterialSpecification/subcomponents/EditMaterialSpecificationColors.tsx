...
export const EditMaterialSpecificationColors = () => {
  ...
  return (
    <div>
      <h3 className="section-heading-aligned">Colors</h3>
            ...
            filteredColors.map(([colorSpecId, colorSpec]) => (
              ...
              >
                ...
                <label htmlFor={"color-name"}>
                  <span className="label-aligned text-xs">Name</span>
                  <TextInput
                    submitValue={(value) => {
                ...
                <label>
                  <span className="label-aligned text-xs">Value</span>
                  <input
                    type="color"
                    name="value"
                ...
                <div className="flex flex-row items-center justify-end">
                  <button
                    ...
                    onClick={() => {
                      ProductActions.removeColorSpec(
                        ProductActions.getMaterialSpec(
                          ProductActions.getComponentSpec(
                            componentSpecId,
                            ProductStore
