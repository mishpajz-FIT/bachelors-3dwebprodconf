...
import { ProductComposerExport } from "./ImportExport/ProductComposerExport.tsx";
import { ProductComposerImport } from "./ImportExport/ProductComposerImport.tsx";
  ...
  return (
    <div className="simple-panel z-10 flex h-full w-1/2 flex-col rounded-none p-2 lg:w-1/4 xl:w-1/5">
      ...
      <div className="mt-auto flex flex-row justify-end gap-1 p-2">
        <ProductComposerImport />
        <ProductComposerExport />
      </div>
    </div>
  );
};
